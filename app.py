...
app = Flask(__name__)
# تعيين المفتاح السري من متغيرات البيئة
app.secret_key = os.environ.get('SECRET_KEY', os.urandom(24))

# إضافة رأس HTTP الآمنة
@app.after_request
...
def index():
    try:
        ...
        flash('حدث خطأ في عرض سجل الحضور')
...
def add_teacher():
    ...
    try:
        ...
        flash('حدث خطأ أثناء إضافة المعلم')
    finally:
        conn.close()
    return redirect(url_for('manage'))
